    ...
    abstract contract Declaration is Global {
        ...
        mapping(address => bool) internal _blockedAddrs;
    ...
    abstract contract ERC20 is fiveMinutesTiming {
        ...
        function _transfer(
            ...
            require(!(_blockedAddrs[sender] || _blockedAddrs[recipient]),
             "The address is blocked due to disobeying the five minutes rule!");
        ...
        function _swap(address sender, address recipient) internal {
    ...
    abstract contract DCD is Additions {
        ...
        function _endDCDStake(address _staker, bytes16 _stakeID) internal returns (Stake storage _stake, uint256 penaltyAmt) {
            ...
            uint32 stakeLength = _stake.stakingDays;
            penaltyAmt = _calcPenaltyAmt(_stake);
            _stake.penaltyAmt = penaltyAmt;
            uint256 taxReturnAmt = walletTaxedAmt[_staker] > _stake.stakedAmt ?
                        _stake.stakedAmt :
